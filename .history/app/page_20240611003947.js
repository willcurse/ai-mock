        ...
        <div className="p-8 md:p-12 lg:px-16 lg:py-24">
          <div className="mx-auto max-w-xl text-center ltr:sm:text-left rtl:sm:text-right">
            ...
            <div className="mt-4 md:mt-8 flex justify-center sm:justify-start space-x-4">
              ...
              <Link href="/signup"
                 className="inline-block rounded bg-blue-300 px-12 py-3 text-sm font-medium text-gray-900 transition hover:bg-blue-400 focus:outline-none focus:ring focus:ring-blue-300">
                  Sign Up
