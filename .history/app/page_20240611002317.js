    ...
    <div className="min-h-screen bg-gray-100 flex flex-col justify-center items-center">
      ...
      <main className="flex-1 flex flex-col justify-center items-center px-4 py-8 sm:px-6 lg:px-8">
        ...
        <div className="flex space-x-4">
          <Link to="/signin">
            <button className="px-6 py-3 bg-indigo-600 text-white rounded-full text-lg font-medium hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500">
              Sign In
            </button>
          </Link>
          <Link to="/signup">
