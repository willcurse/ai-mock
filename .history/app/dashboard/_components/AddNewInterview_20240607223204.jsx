...
const AddNewInterview = () => {
  ...
  const onSubmit =async (e) => {
    ...
    //AI integration....
    const InputPrompt='job position:'+jobPosition+', job description : '+jobDescription+' ,year of exprience: '+yearsOfExperience+',Depends on this prompt give my '+process.env.NEXT_PUBLIC_INTERVIEW_QUESTIONS+' interview questions'
