...
const AddNewInterview = () => {
  ...
  const onSubmit = async (e) => {
    ...
    try {
      ...
      const JsonReplace = result.response.text().replace('`json', '').replace('`', '');
      const jsonData = JSON.parse(JsonReplace); // Parse only if valid JSON
      console.log(jsonData); // Use the parsed interview questions
    } catch (error) {
      console.error("Error from AI:", error.message);
