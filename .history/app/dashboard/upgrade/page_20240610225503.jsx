        ...
        <div className="rounded-2xl border border-gray-200 p-6 shadow-sm sm:px-8 lg:p-12">
          ...
          <ul className="mt-6 space-y-2">
            <li className="flex items-center gap-1">
              ...
              <span className="text-gray-700"> 2 mock interviews per month </span>
            </li>
            <li className="flex items-center gap-1">
              <svg
                xmlns="http://www.w3.org/2000/svg"
        ...
        <div className="rounded-2xl border border-indigo-600 p-6 shadow-sm ring-1 ring-indigo-600 sm:px-8 lg:p-12">
          ...
          <ul className="mt-6 space-y-2">
            <li className="flex items-center gap-1">
              ...
              <span className="text-gray-700"> 10 mock interviews per month </span>
            </li>
            <li className="flex items-center gap-1">
              <svg
                xmlns="http://www.w3.org/2000/svg"
        ...
        <div className="rounded-2xl border border-gray-200 p-6 shadow-sm sm:px-8 lg:p-12">
          ...
          <ul className="mt-6 space-y-2">
            <li className="flex items-center gap-1">
              ...
              <span className="text-gray-700"> 20 mock interviews per month </span>
            </li>
            <li className="flex items-center gap-1">
              <svg
                xmlns="http://www.w3.org/2000/svg"
