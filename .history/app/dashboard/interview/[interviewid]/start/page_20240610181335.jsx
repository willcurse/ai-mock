  ...
  return (
    <div>
        ...
        <div className='flex items-center
         justify-between m-3' >
        {activeIndex>0 &&<Button colorScheme='blue'>Previous Question</Button>}
        {activeIndex!=interviewQuestion?.length-1 &&<Button colorScheme='blue'>Next Question</Button>}
        {activeIndex==interviewQuestion?.length-1 &&<Button colorScheme='blue'>End Interview</Button>}
        </div>
    </div>
  )
}
