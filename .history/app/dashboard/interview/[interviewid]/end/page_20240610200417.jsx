          ...
          <Collapsible key={index} className="border-b border-gray-200 mb-4">
            ...
            <CollapsibleContent className="p-4 bg-white rounded-b-md">
              <div className='space-y-2'>
                ...
                <p className='bg-green-100 w-full p-4 rounded-t-md'><strong>Correct Answer:</strong> {feedback.correctAns}</p>
                <p className='bg-blue-100 w-full p-4 rounded-t-md'><strong>Feedback:</strong> {feedback.feedback}</p>
              </div>
            </CollapsibleContent>
          </Collapsible>
        ))}
