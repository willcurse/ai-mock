    ...
    <div className="my-10 flex justify-center items-center flex-col space-y-6">
      ...
      {interviewData && (
        <div className="mt-8 p-6 bg-white rounded-lg shadow-lg max-w-2xl">
          <h2 className="text-xl font-semibold text-gray-800">Your Interview Details</h2>
          ...
          <p className="mt-2 text-gray-600"><strong>Years of Experience:</strong> {interviewData.jobexp} <h1> Years</h1></p>
